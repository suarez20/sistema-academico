...
$id_userEstudiante = $_GET['id'];
$busc_userEstudiante = buscarUserEstudianteById($conexion, $id_userEstudiante);
$res_b_userEstudiante = mysqli_fetch_array($busc_userEstudiante);
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="operaciones/actualizar_estudiante.php">
                        <input type="hidden" name="id" value="<?php echo $id_userEstudiante;?>">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">USUARIO :
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="dni" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $res_b_userEstudiante['usuario']; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="nom_ap" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $res_b_userEstudiante['password']; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="Usuario_estudiante.php"><button class="btn btn-primary" type="button">Cancelar</button></a>
